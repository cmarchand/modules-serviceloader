...
public class ShadedLicenseValidatorTest {
  ...
  public void given_christophe_and_free_checksum_should_be_xxx() {
    // given
    License license = new License("Christophe Marchand", LicenseLevel.FREE, "xxx");
  ...
  public void given_christophe_and_profesional_checksum_should_be_xxx() {
    // given
    License license = new License("Christophe Marchand", LicenseLevel.PROFESSIONAL, "xxx");
  ...
  public void given_christophe_and_enterprise_checksum_should_be_xxx() {
    // given
    License license = new License("Christophe Marchand", LicenseLevel.ENTERPRISE, "xxx");
